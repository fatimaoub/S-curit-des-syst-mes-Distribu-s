...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                //n'essecite pas authentification
                .authorizeHttpRequests(ar->ar.requestMatchers("/","/oauth2Login/**","/webjars/**","/h2-console/**").permitAll())
                .authorizeHttpRequests(ar->ar.anyRequest().authenticated())
                .headers(h->h.frameOptions(fo->fo.disable()))
                //pour le premier test en arrete a ce niveau puis aprés en vas commenter cette ligne
                //cette ligne pour liste de methodes d'aut automatique .oauth2Login(Customizer.withDefaults())
                .oauth2Login(al->
                ...
                //si l'utilisateur n'a pad le droit a acceder fiha redirection vers le controleur
    ...
    //cette methode pour deconnecter un utilisateur keyckloak
   private OidcClientInitiatedLogoutSuccessHandler oidcLogoutSuccessHandler() {
    ...
    // pour mapper les roles (prendre les roles en consideration)
    @Bean
